    ...
    <PageContainer className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex flex-1 min-h-0 justify-center">
        <div className="flex flex-1 min-h-0 gap-0 md:gap-8 max-w-3xl w-full">
              ...
              {leftTab === "analyses" ? (
                <>
                  {analyses.length === 0 && !analysisInProgress && (
                    <EmptyState message="No analyses yet" size="compact" />
                  )}
                  {analysisInProgress && (
                ...
                <>
                  {researchNotes.length === 0 && (
                    <EmptyState message="No research notes yet" size="compact" />
                  )}
                  {researchNotes.map((n) => (
                    <div
                      key={n.id}
          ...
          {/* Content */}
          <div
            className={`flex-1 min-w-0 overflow-y-auto flex-col ${mobileShowContent ? "flex" : "hidden md:flex"}`}
          >
            {/* Mobile back */}
            {leftTab === "analyses" && (
              <button
            ...
            {leftTab === "research" ? (
              ...
              <div className="max-w-2xl w-full pb-8">
                ...
                {analysisError && (
                  <p className="text-sm text-destructive mt-2">Error: {analysisError}</p>
                )}
